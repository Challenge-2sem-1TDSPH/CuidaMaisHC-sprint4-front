...
export default function Cabecalho(){
    ...
    return(
        <header className="w-[100vw] flex flex-col bg-white shadow-lg lg:bg-[var(--btn-color-menu)] lg:h-[20vh]">
            <div className="text-center flex flex-wrap justify-between items-center w-full h-[16vh] fixed bg-white p-2 shadow-md sm:h-[22vh] sm:p-5 md:h-[17vh] lg:h-[13.5vh] lg:p-1 xl:h-[14.5vh] 2xl:h-[13.5vh]">
