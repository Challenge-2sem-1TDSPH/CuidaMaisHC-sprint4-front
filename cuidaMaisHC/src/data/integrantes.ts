...
export const integrantes:TipoIntegrante[] = [
    {
      ...
      urlImg: `${moises}`,
      paragrafo: "Olá! sou o Moisés Waidemann Molinillo Júnior, tenho 18 anos, estudo Análise e Desenvolvimentos de Sistema na Fiap, da turma 1TDSPH manhã.",
    ...
    }, 
    {
      ...
      nome: "Gabriel Sbrana",
      urlImg: `${gabriel}`,
      paragrafo: "Olá, sou o Gabriel Sbrana Campos. Tenho 18 anos, sou estudante de Análise e Desenvolvimento de Sistemas na FIAP, estou desenvolvendo uma solução para o Hospital das Clínicas, da turma 1TDSPH.",
    ...
    },
    {
      ...
      nome: "Thiago Mota",
      urlImg: `${thiago}`,
      paragrafo: "Olá, sou o Thiago Rodrigues da Mota. Tenho 20 anos, sou estudante de Análise e Desenvolvimento de Sistemas na FIAP, estou desenvolvendo uma solução para o Hospital das Clínicas.",
